  ...
  define([
      ...
      return function(
          ...
          fullNameFieldData = {
              ...
              valueAttribute: 'name',
              helpMessage: gettext('The name that is used for ID verification and that appears on your certificates and inside the {platform_name}.'),  // eslint-disable-line max-len,
              persistChanges: true
          };
